...
ap.add_argument("-v", "--video", type=str, default="video/run.mp4")
...
prott1 = 'model\MobileNetSSD_deploy.prototxt'
prott2 = 'model\mobilenet_iter_73000.caffemodel'
...
while True:
    ...
    trackbox = cv2.resize(frame, (224, 224))
    ...
    if initBB2 is not None and lastframe is not None:
